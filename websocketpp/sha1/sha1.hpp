...
#ifdef _MSC_VER
#pragma warning(push)
#pragma warning(suppress: 6386) // Suppress Visual Studio code analysis for write overrun. It doesn't know the index into Message_Block is protected by checking length.
#endif
